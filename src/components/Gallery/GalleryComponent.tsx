...
export default function GalleryComponent() {
    ...
    let galleryThumbs = [
        {name: 'Nordic Fire Festival 2022', url: '/images/thumbs/nff22_thumb.jpg', link: 'nff2022'},
            ...
            <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
                <div className="space-y-12">
                    <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                        <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">Galleries</h2>
                    </div>
                    <ul
                        role="list"
                            ...
                            <li key={gallery.name}>
                                <div className="space-y-4">
                                    <div className="aspect-w-3 aspect-h-2">
                                        <img className="object-cover shadow-lg rounded-lg" src={gallery.url} alt="" />
                                    </div>
